class Account::ActsController < Account::ApplicationController
  ...
  # GET /account/teams/:team_id/acts
  # GET /account/teams/:team_id/acts.json
  def index
  ...
  # GET /account/teams/:team_id/acts/new
  def new
  end
  ...
  # POST /account/teams/:team_id/acts
  # POST /account/teams/:team_id/acts.json
  def create
  ...
  def destroy
    @act.destroy
    respond_to do |format|
      format.html { redirect_to [:account, @team, :acts], notice: I18n.t("acts.notifications.destroyed") }
