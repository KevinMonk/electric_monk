class Account::FlowsController < Account::ApplicationController
  ...
  # GET /account/acts/:act_id/flows
  # GET /account/acts/:act_id/flows.json
  def index
  ...
  # GET /account/acts/:act_id/flows/new
  def new
  end
  ...
  # POST /account/acts/:act_id/flows
  # POST /account/acts/:act_id/flows.json
  def create
  ...
  def destroy
    @flow.destroy
    respond_to do |format|
      format.html { redirect_to [:account, @act, :flows], notice: I18n.t("flows.notifications.destroyed") }
